...
class Etheme_Megatronsimple_Block_Megatronsimple extends Mage_Core_Block_Template
{
    ...
    {
        if (!$this->hasData('megatronsimple'))$this->setData('megatronsimple', Mage::registry('megatronsimple'));
        else return $this->getData('megatronsimple');
    }
